<x-base-layout>
    ...
    {{-- 
    <script src="{{asset('demo1/js/custom/apps/user-management/users/list/table.js')}}"></script>
    <script src="{{asset('demo1/js/custom/apps/user-management/users/list/export-users.js')}}"></script>
    <script src="{{asset('demo1/js/custom/apps/user-management/users/list/add.js')}}"></script>
